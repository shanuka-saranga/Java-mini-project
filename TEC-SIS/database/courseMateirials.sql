...
VALUES
    ...
    (1, 'Week 02 OOP Basics', 'Lecture notes for OOP basics.', 'storage/course-materials/ict2142/week02-oop-basics.pdf', 'PDF', 2, 'ACTIVE'),
    (2, 'Business Economics Reading', 'Reference reading material.', 'storage/course-materials/tcs2112/business-economics-reading.pdf', 'PDF', 2, 'ACTIVE');
